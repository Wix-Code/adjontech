...
const Page = () => {
  ...
  return (
    <div className="p-5 max-w-[1000px] m-auto space-y-4">
      <img data-aos="fade-right" src={service.img} alt={service.name} className="h-[300px] object-cover w-full" />
      <h1 data-aos="fade-right" className="text-2xl font-bold capitalize">{service.name}</h1>
      <p data-aos="fade-right" className="text-[14px] text-[#4e4e4e]">{service?.note || 'No description available.'}</p>

      <div data-aos="fade-right" className="space-y-2 flex flex-col">
